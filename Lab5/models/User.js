...
let userSchema = mongoose.Schema({
  ...
  firstName: {
    type: mongoose.Schema.Types.String,
    required: propertyIsRequired.replace('{0}', 'Firstname')
  },
  lastName: {
    type: mongoose.Schema.Types.String,
    required: propertyIsRequired.replace('{0}', 'Lastname')
  },
  age: {
  ...
  createCategories: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Category' }]
})
